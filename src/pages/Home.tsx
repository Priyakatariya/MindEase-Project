...
import { MessageCircle, BarChart3, Users, Heart, ArrowRight, }
from 'lucide-react';
          ...
          <FadeIn>
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-14">
                ...
                <h2 className="text-4xl md:text-5xl font-black mb-3 tracking-tight" style={{ color: '#3D1520' }}>Meet Your Guides</h2>
